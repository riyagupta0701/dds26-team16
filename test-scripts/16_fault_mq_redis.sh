#!/usr/bin/env bash
# Test 16: Fault tolerance — kill mq-redis (message queue broker).
#
...
# mq-redis restarts, and WAL recovery should clean up any stuck transactions.
source "$(dirname "$0")/helpers.sh"

header "TEST 16 — Fault Tolerance: MQ Redis Failure"
